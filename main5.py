...
The mouse control has been updated to an instant, absolute positioning system with corrected direction.
...
def update_mouse_position_instantly(pitch, yaw):
    ...
    if abs(yaw) < MOUSE_DEAD_ZONE and abs(pitch) < MOUSE_DEAD_ZONE:
        ...
        # Arah horizontal (yaw) dibalik agar sesuai
...
try:
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            # PERBAIKAN: Menyamakan sensitivitas pitch dan yaw untuk visualisasi yang seimbang.
